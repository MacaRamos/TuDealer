        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools pull-right">
                    <a href="{{ route('publicaciones.index') }}" class="btn btn-block btn-sm ">
                        <i class="fas fa-reply"></i> Tus publicaciones
                    </a>
                </div>
            </div>
            <!-- form start -->
            <form action="{{ route('publicaciones.store') }}" id="form-general" class="form-horizontal" method="POST"
                autocomplete="off">
                @csrf @method('post')
                <div class="card-body">
                    @if ($errors->any())
